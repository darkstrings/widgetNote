...
`;
    ...
    textArea.value = text;
    main.innerHTML = (0, _marked.marked).parse(text);
    ...
    textArea.addEventListener("input", (e)=>{
        ...
        main.innerHTML = (0, _marked.marked).parse(value);
        updateLS();
    });
...
},{"marked":"4duqf"}],"4duqf":[function(require,module,exports) {
/**
   ...
   */ marked.use = function() {
        ...
        args.forEach(function(pack) {
            ...
            if (pack.tokenizer) {
                ...
                for(var _prop in pack.tokenizer)_loop2(_prop);
            ...
            if (pack.hooks) {
                ...
                var _loop3 = function _loop3(_prop2) {
                    ...
                    if (Hooks.passThroughHooks.has(_prop2)) hooks[_prop2] = function(arg) {
                        if (marked.defaults.async) return Promise.resolve(pack.hooks[_prop2].call(hooks, arg)).then(function(ret) {
                ...
                for(var _prop2 in pack.hooks)_loop3(_prop2);
                opts.hooks = hooks;
            }
...
},{}]},["dpgAG","6rimH"], "6rimH", "parcelRequire716c")
